...
if DEBUG == '1':
    ...
    gcc.Append(CCFLAGS=' -march=native -O3 -fomit-frame-pointer -Wall -Wmissing-declarations -Wsign-compare -Wno-sign-conversion -Wold-style-cast -Wno-parentheses -Wno-attributes -Wno-maybe-uninitialized')
